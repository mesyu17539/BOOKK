	...
	bookNav:x=>{
		...
		list:x=>{
				...
				for(var i=0;i<x.largeList.length;i++){
					$(createTr({
						id:'list-content-tr-'+i+''
					})).appendTo('#list-content-table');
					$(createTd({
						id:'list-left-td-'+i+'',
						clazz:'product-image'
					})).appendTo('#list-content-tr-'+i+'');
					$(createTd({
						id:'list-right-td-'+i+'',
						clazz:'product-info'
					})).appendTo('#list-content-tr-'+i+'');
					$(createATag({
						id:'list-left-a-'+i+'',
						val:''
					})).attr('class','move-detail').attr('value',x.largeList[i].bookNum).appendTo('#list-left-td-'+i+'');
					$(createDiv({
						id:'list-left-div-'+i+'',
						clazz:'book-cover'
					})).appendTo('#list-left-a-'+i+'');
					$(createImg({
						src:x.largeList[i].imageRoute
					})).appendTo('#list-left-div-'+i+'');
					$(DcreateHTag({
						size:'3',
						val:'',
						clazz:'list-right-htag-'+i+''
					})).appendTo('#list-right-td-'+i+'');
					$(createATag({
						val:x.largeList[i].bookName
					})).appendTo('.list-right-htag-'+i+'').attr('value',x.largeList[i].bookNum).attr('class','a-list-name');
					$(createDiv({
						id:'list-right-div-'+i+'',
						clazz:'product-meta'
					})).appendTo('#list-right-td-'+i+'');
					$(DcreateSpan({
						id:'list-right-span-'+i+'',
						val:'저자 ',
						clazz:'list-right-span'
					})).appendTo('#list-right-div-'+i+'');
					$(createATag({
						id:'list-right-writter-a-'+i+'',
						val:x.largeList[i].writter
					})).appendTo('#list-right-span-'+i+'');
					$(DcreateSpan({
						val:x.largeList[i].publisher,
						clazz:'list-right-publisher&nbsp;&nbsp;&nbsp;'
					})).appendTo('#list-right-div-'+i+'');
					$(DcreateSpan({
						val:x.largeList[i].publishingDate,
						clazz:'list-right-span last'
					})).appendTo('#list-right-div-'+i+'');
					$(createDiv({
						id:'list-right-price-div-'+i+'',
						clazz:'product-price'
					})).appendTo('#list-right-td-'+i+'');
					$(createStrong({
						val:x.largeList[i].price
					})).appendTo('#list-right-price-div-'+i+'');
					$(DcreateSpan({
						val:'원',
						clazz:'currency'
					})).appendTo('#list-right-price-div-'+i+'');
					$(createForm({
						id:'list-right-form-'+i+'',
						clazz:'btn-group'
					})).appendTo('#list-right-td-'+i+'');
					$(createButton({
						id:'btn-cart-'+i+'',
						...
						val:'&nbsp;&nbsp;장바구니'
					})).attr('value',x.largeList[i].bookNum).appendTo('#list-right-form-'+i+'');
					$(createButton({
						clazz:'btn btn-primary fas fa-arrow-right cart',
						val:'&nbsp;&nbsp;바로구매'
					})).appendTo('#list-right-form-'+i+'');
					$(createButton({
